...
public class Attack extends EnergyUsage {
    ...
    public EntityState execute(Entities attacker, Entities defender) {
    ...
    public EntityState execute(Entities attacker, double VULNERABILITY_DEBUFF, Entities defender){
